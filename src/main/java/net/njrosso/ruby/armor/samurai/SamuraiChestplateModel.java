...
public class SamuraiChestplateModel<T extends LivingEntity> extends HumanoidModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("modid", "chestplate"), "main");
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer buffer, int packedLight, int packedOverlay, int color) {
        ...
        this.rightA.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.leftA.render(poseStack, buffer, packedLight, packedOverlay, color);
    }
}
