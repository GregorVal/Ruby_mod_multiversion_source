...
public class SamuraiLeggingsModel<T extends LivingEntity> extends HumanoidModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("modid", "legs"), "main");
    private final ModelPart leftLA;
    private final ModelPart rightLA;

    public SamuraiLeggingsModel(ModelPart root) {
        super(root);
    ...
    public void renderToBuffer(PoseStack arg0, VertexConsumer arg1, int arg2, int arg3, int arg4) {
        this.leftLA.render(arg0, arg1, arg2, arg3, arg4);
        this.rightLA.render(arg0, arg1, arg2, arg3, arg4);
    }
}