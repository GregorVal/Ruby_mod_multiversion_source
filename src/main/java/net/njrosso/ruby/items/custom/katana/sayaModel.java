...
public class sayaModel<T extends LivingEntity> extends HumanoidModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RubyMod.MODID, "textures/models/armor/saya"), "main");
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
        holder.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
